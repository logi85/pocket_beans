...
class ScheduleAdapter(private var _items: List<ScheduleListItem>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class EventViewHolder(private val _binding: ScheduleRvEventItemBinding) : RecyclerView.ViewHolder(_binding.root) {
